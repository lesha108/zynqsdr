...
set_property -dict {PACKAGE_PIN G14 IOSTANDARD LVCMOS33} [get_ports clkout_out]

## push-buttons- led- dip-switches- loopbacks- (ps7 gpio)

set_property -dict {PACKAGE_PIN C20 IOSTANDARD LVCMOS33} [get_ports {gpio_bd[0]}]
set_property -dict {PACKAGE_PIN B20 IOSTANDARD LVCMOS33} [get_ports {gpio_bd[1]}]
set_property -dict {PACKAGE_PIN B19 IOSTANDARD LVCMOS33} [get_ports {gpio_bd[2]}]
set_property -dict {PACKAGE_PIN A20 IOSTANDARD LVCMOS33} [get_ports {gpio_bd[3]}]

## orphans- io- (ps7 gpio)

set_property -dict {PACKAGE_PIN E17 IOSTANDARD LVCMOS33} [get_ports {gpio_bd[4]}]
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports {gpio_bd[5]}]
set_property -dict {PACKAGE_PIN D19 IOSTANDARD LVCMOS33} [get_ports {gpio_bd[6]}]
set_property -dict {PACKAGE_PIN D20 IOSTANDARD LVCMOS33} [get_ports {gpio_bd[7]}]

## ps7- fixed io- to- fpga regular io (ps7 gpio)

set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS33} [get_ports {gpio_bd[8]}]
set_property -dict {PACKAGE_PIN E19 IOSTANDARD LVCMOS33} [get_ports {gpio_bd[9]}]
set_property -dict {PACKAGE_PIN F16 IOSTANDARD LVCMOS33} [get_ports {gpio_bd[10]}]
...
# gpio 1 as freq uartlite output
set_property -dict {PACKAGE_PIN K14 IOSTANDARD LVCMOS33} [get_ports tx_0]
# gpio 2 as PTT output
set_property -dict {PACKAGE_PIN J14 IOSTANDARD LVCMOS33} [get_ports ptt_0]
#set_property -dict {PACKAGE_PIN J20 IOSTANDARD LVCMOS33} [get_ports tx_0]

set_property PACKAGE_PIN H16 [get_ports TCXO_CLK]
set_property IOSTANDARD LVCMOS33 [get_ports TCXO_CLK]
set_property PACKAGE_PIN K18 [get_ports GPS_PPS]
...
set_property PACKAGE_PIN K17 [get_ports PPS_EXT_IN]
set_property PACKAGE_PIN H18 [get_ports TCXO_DAC_SYNC_N]
set_property PACKAGE_PIN F20 [get_ports TCXO_DAC_SDIN]
set_property PACKAGE_PIN F19 [get_ports TCXO_DAC_SCLK]
...
create_clock -period 25.000 -name TCXO_CLK -waveform {0.000 12.500} [get_ports TCXO_CLK]
