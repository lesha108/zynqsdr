...
"dfu_sf=gpio set 106;set stdout serial@e0001000;echo Entering DFU SF mode ... && run dfu_sf_info && dfu 0 sf 0:0:40000000:0 && if test -n ${dfu_alt_num} && test ${dfu_alt_num} = 1; "\
"then set fit_size ${filesize} && set dfu_alt_num && env save; fi;gpio clear 106;\0"
...
#define CONFIG_EXTRA_ENV_SETTINGS	\
	...
	"qspiboot=set stdout nulldev;adi_hwref;test -n $PlutoRevA || gpio input 12 && set stdout serial@e0001000 && sf probe && sf protect lock 0 100000 && run dfu_sf;  " \
