...
${INSTALL} -D -m 0755 ${BOARD_DIR}/banddata.sh ${TARGET_DIR}/sbin/
${INSTALL} -D -m 0755 ${BOARD_DIR}/autorun_template.sh ${TARGET_DIR}/sbin/
${INSTALL} -D -m 0755 ${BOARD_DIR}/watchconsoletx.sh ${TARGET_DIR}/sbin/
